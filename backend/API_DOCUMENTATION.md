# 📡 FlashyBank API - Documentación Completa
...
**Error 401 - Refresh token inválido**:
```json
{
  "timestamp": "2025-01-25T10:30:00",
  "status": 401,
...
**Documentación generada**: 2025-01-25
